...
class WPSC_PS_All_Results_Page_Settings extends WPSC_Predictive_Search_Admin_UI
{
	...
	public function __construct() {
		...
		$this->form_messages = array(
				'success_message'	=> __( 'All Results Pages successfully saved.', 'wp-e-commerce-predictive-search' ),
				'error_message'		=> __( 'Error: All Results Pages can not save.', 'wp-e-commerce-predictive-search' ),
				'reset_message'		=> __( 'All Results Pages successfully reseted.', 'wp-e-commerce-predictive-search' ),
			);
	...
	public function subtab_data() {
		...
		$subtab_data = array( 
			...
			'label'				=> __( 'All Results Pages', 'wp-e-commerce-predictive-search' ),
	...
	public function init_form_fields() {
     	...
     	$this->form_fields = apply_filters( $this->option_name . '_settings_fields', array(
			...
			array(
            	'name' 		=> __( 'Search results page settings', 'wp-e-commerce-predictive-search' ),
                'type' 		=> 'heading',
           	),
			array(  
				'name' 		=> __( 'Results', 'wp-e-commerce-predictive-search' ),
				'desc' 		=> __('The number of results to show before endless scroll click to see more results.', 'wp-e-commerce-predictive-search' ),
			...
			array(  
				'name' 		=> __( 'Description character count', 'wp-e-commerce-predictive-search' ),
				'desc' 		=> __('The number of characters from product descriptions that shows with each search result.', 'wp-e-commerce-predictive-search' ),
			...
			array(  
				'name' 		=> __( 'SKU', 'wp-e-commerce-predictive-search' ),
				'desc' 		=> __('ON to show product SKU with search results', 'wp-e-commerce-predictive-search' ),
			...
			array(  
				...
				'desc' 		=> __('ON to show product price with search results', 'wp-e-commerce-predictive-search' ),
			...
			array(  
				'name' 		=> __( 'Product Categories', 'wp-e-commerce-predictive-search' ),
				'desc' 		=> __('On to show categories with search results', 'wp-e-commerce-predictive-search' ),
			...
			array(  
				'name' 		=> __( 'Product Tags', 'wp-e-commerce-predictive-search' ),
				'desc' 		=> __('On to show tags with search results', 'wp-e-commerce-predictive-search' ),
