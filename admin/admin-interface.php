...
class WPSC_Predictive_Search_Admin_Interface extends WPSC_Predictive_Search_Admin_UI
{
	...
	public function get_success_message( $message = '' ) {
		if ( trim( $message ) == '' ) $message = __( 'Settings successfully saved.' , 'wp-e-commerce-predictive-search' ); 
	...
	public function get_error_message( $message = '' ) {
		if ( trim( $message ) == '' ) $message = __( 'Error: Settings can not save.' , 'wp-e-commerce-predictive-search' ); 
	...
	public function get_reset_message( $message = '' ) {
		if ( trim( $message ) == '' ) $message = __( 'Settings successfully reseted.' , 'wp-e-commerce-predictive-search' ); 
		return '<div class="updated" id=""><p>' . $message . '</p></div>';
	}
	...
	public function get_font_weights() {
		$font_weights = array (
			'300'				=> __( 'Thin', 'wp-e-commerce-predictive-search' ),
			'300 italic'		=> __( 'Thin/Italic', 'wp-e-commerce-predictive-search' ),
			'normal'			=> __( 'Normal', 'wp-e-commerce-predictive-search' ),
			'italic'			=> __( 'Italic', 'wp-e-commerce-predictive-search' ),
			'bold'				=> __( 'Bold', 'wp-e-commerce-predictive-search' ),
			'bold italic'		=> __( 'Bold/Italic', 'wp-e-commerce-predictive-search' ),
		);
	...
	public function get_border_styles() {
		$border_styles = array (
			'solid'				=> __( 'Solid', 'wp-e-commerce-predictive-search' ),
			'double'			=> __( 'Double', 'wp-e-commerce-predictive-search' ),
			'dashed'			=> __( 'Dashed', 'wp-e-commerce-predictive-search' ),
			'dotted'			=> __( 'Dotted', 'wp-e-commerce-predictive-search' ),
			'groove'			=> __( 'Groove', 'wp-e-commerce-predictive-search' ),
			'ridge'				=> __( 'Ridge', 'wp-e-commerce-predictive-search' ),
			'inset'				=> __( 'Inset', 'wp-e-commerce-predictive-search' ),
			'outset'			=> __( 'Outset', 'wp-e-commerce-predictive-search' ),
		);
	...
	public function admin_forms( $options, $form_key, $option_name = '', $form_messages = array() ) {
		...
		foreach ( $options as $value ) {
			...
			switch( $value['type'] ) {
							...
							<fieldset>
								...
								if ( is_array( $value['onoff_options'] ) && count( $value['onoff_options'] ) > 0 ) {
									foreach ( $value['onoff_options'] as $i_option ) {
										if ( ! isset( $i_option['checked_label'] ) ) $i_option['checked_label'] = __( 'ON', 'wp-e-commerce-predictive-search' );
										if ( ! isset( $i_option['unchecked_label'] ) ) $i_option['unchecked_label'] = __( 'OFF', 'wp-e-commerce-predictive-search' );
				...
				case 'onoff_checkbox' :
					...
					if ( ! isset( $value['checked_value'] ) ) $value['checked_value'] = 1;
					if ( ! isset( $value['checked_label'] ) ) $value['checked_label'] = __( 'ON', 'wp-e-commerce-predictive-search' );
					if ( ! isset( $value['unchecked_label'] ) ) $value['unchecked_label'] = __( 'OFF', 'wp-e-commerce-predictive-search' );
				...
				case 'image_size' :
					...
					?><tr valign="top">
						...
						<td class="forminp forminp-<?php echo sanitize_title( $value['type'] ) ?>">
							...
							<label><?php _e( 'Width', 'wp-e-commerce-predictive-search' ); ?> <input name="<?php echo $name_attribute; ?>[width]" id="<?php echo $id_attribute; ?>-width" type="text" class="a3rev-ui-<?php echo sanitize_title( $value['type'] ) ?>-width" value="<?php echo $width; ?>" /></label>
	
							<label><?php _e( 'Height', 'wp-e-commerce-predictive-search' ); ?> <input name="<?php echo $name_attribute; ?>[height]" id="<?php echo $id_attribute; ?>-height" type="text" class="a3rev-ui-<?php echo sanitize_title( $value['type'] ) ?>-height" value="<?php echo $height; ?>" /></label>
	
							<label><?php _e( 'Hard Crop', 'wp-e-commerce-predictive-search' ); ?> <input name="<?php echo $name_attribute; ?>[crop]" id="<?php echo $id_attribute; ?>-crop" type="checkbox" class="a3rev-ui-<?php echo sanitize_title( $value['type'] ) ?>-crop" <?php echo $crop; ?> /></label>
						...
						<td class="forminp">
                           ...
                           <!-- Font Face -->
							<select
								...
								>
								<optgroup label="<?php _e( '-- Default Fonts --', 'wp-e-commerce-predictive-search' ); ?>">
                                <?php
                                ...
                                <optgroup label="<?php _e( '-- Google Fonts --', 'wp-e-commerce-predictive-search' ); ?>">
                                <?php
                           ...
                           <!-- Preview Button -->
                           <div class="a3rev-ui-typography-preview"><a href="#" class="a3rev-ui-typography-preview-button button submit-button" title="<?php _e( 'Preview your customized typography settings', 'wp-e-commerce-predictive-search' ); ?>"><span>&nbsp;</span></a></div>
				...
				case 'border':
					...
					?><tr valign="top">
						...
						<td class="forminp forminp-border_corner">
                           ...
                           <!-- Preview Button -->
                           <div class="a3rev-ui-settings-preview"><a href="#" class="a3rev-ui-border-preview-button a3rev-ui-settings-preview-button button submit-button" title="<?php _e( 'Preview your customized border settings', 'wp-e-commerce-predictive-search' ); ?>"><span>&nbsp;</span></a></div>
                           ...
                           <!-- Border Corner : Rounded or Square -->
								<input
                                    ...
                                    checked_label="<?php _e( 'Rounded', 'wp-e-commerce-predictive-search' ); ?>"
                                    unchecked_label="<?php _e( 'Square', 'wp-e-commerce-predictive-search' ); ?>"
                                    type="checkbox"
                                    value="rounded"
							...
							<!-- Border Rounded Value -->
								<div class="a3rev-ui-border-corner-value-container">
                                	<div class="a3rev-ui-border_corner-top_left">
                                        <span class="a3rev-ui-border_corner-span"><?php _e( 'Top Left Corner', 'wp-e-commerce-predictive-search' ); ?></span>
                                    ...
                                    <div class="a3rev-ui-border_corner-top_right">
                                        <span class="a3rev-ui-border_corner-span"><?php _e( 'Top Right Corner', 'wp-e-commerce-predictive-search' ); ?></span> 
                                        <div class="a3rev-ui-slide-container">
                                            <div class="a3rev-ui-slide-container-start">
                                                <div class="a3rev-ui-slide-container-end">
                                    ...
                                    <div class="a3rev-ui-border_corner-bottom_right">
                                        <span class="a3rev-ui-border_corner-span"><?php _e( 'Bottom Right Corner', 'wp-e-commerce-predictive-search' ); ?></span> 
                                        <div class="a3rev-ui-slide-container">
                                            <div class="a3rev-ui-slide-container-start">
                                                <div class="a3rev-ui-slide-container-end">
                                    ...
                                    <div class="a3rev-ui-border_corner-bottom_left">
                                        <span class="a3rev-ui-border_corner-span"><?php _e( 'Bottom Left Corner', 'wp-e-commerce-predictive-search' ); ?></span>
                                        <div class="a3rev-ui-slide-container"> 
                                            <div class="a3rev-ui-slide-container-start">
                                                <div class="a3rev-ui-slide-container-end">
				...
				case 'border_styles':
					...
					?><tr valign="top">
						...
						<td class="forminp">
                           ...
                           <!-- Preview Button -->
                           <div class="a3rev-ui-settings-preview"><a href="#" class="a3rev-ui-border-preview-button a3rev-ui-settings-preview-button button submit-button" title="<?php _e( 'Preview your customized border styles settings', 'wp-e-commerce-predictive-search' ); ?>"><span>&nbsp;</span></a></div>
                           </div>
					...
					?><tr valign="top">
						...
						<td class="forminp forminp-box_shadow">
                            ...
                            <input
                                    ...
                                    checked_label="<?php _e( 'YES', 'wp-e-commerce-predictive-search' ); ?>"
                                    unchecked_label="<?php _e( 'NO', 'wp-e-commerce-predictive-search' ); ?>"
                                    type="checkbox"
                                    value="1"
							...
							<select
                                ...
                                data-placeholder="<?php _e( 'Horizontal Shadow', 'wp-e-commerce-predictive-search' ); ?>"
								>
								<?php
									for ( $i = -20; $i <= 20; $i++ ) {
										?>
							...
							<select
                                ...
                                data-placeholder="<?php _e( 'Vertical Shadow', 'wp-e-commerce-predictive-search' ); ?>"
								>
								<?php
									for ( $i = -20; $i <= 20; $i++ ) {
										?>
                           ...
                           <!-- Box Blur Distance -->
							<select
                                ...
                                data-placeholder="<?php _e( 'Blur Distance', 'wp-e-commerce-predictive-search' ); ?>"
								>
								<?php
									for ( $i = 0; $i <= 20; $i++ ) {
										?>
                           ...
                           <!-- Box Spread -->
							<select
                                ...
                                data-placeholder="<?php _e( 'Spread Size', 'wp-e-commerce-predictive-search' ); ?>"
								>
								<?php
									for ( $i = 0; $i <= 20; $i++ ) {
										?>
                           ...
                           <!-- Box Shadow Inset -->
                                <input
                                    ...
                                    checked_label="<?php _e( 'INNER', 'wp-e-commerce-predictive-search' ); ?>"
                                    unchecked_label="<?php _e( 'OUTER', 'wp-e-commerce-predictive-search' ); ?>"
                                    type="checkbox"
                                    value="inset"
                           ...
                           <input
                            ...
                            <!-- Preview Button -->
                           <div class="a3rev-ui-settings-preview"><a href="#" class="a3rev-ui-box_shadow-preview-button a3rev-ui-settings-preview-button button submit-button" title="<?php _e( 'Preview your customized box shadow settings', 'wp-e-commerce-predictive-search' ); ?>"><span>&nbsp;</span></a></div>   
                           </div>
                           <div style="clear:both;"></div>
                           </div>
						</td>
		...
		<?php do_action( $this->plugin_name . '-' . trim( $form_key ) . '_settings_end' ); ?>
            <p class="submit">
                    <input type="submit" value="<?php _e('Save changes', 'wp-e-commerce-predictive-search' ); ?>" class="button button-primary" name="bt_save_settings" />
                    <input type="submit" name="bt_reset_settings" class="button" value="<?php _e('Reset Settings', 'wp-e-commerce-predictive-search' ); ?>"  />
