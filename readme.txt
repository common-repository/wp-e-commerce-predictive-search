...
Want to add a new language to WooCommerce Dynamic Gallery! You can contribute via [translate.wordpress.org](https://translate.wordpress.org/projects/wp-plugins/wp-e-commerce-predictive-search)
...
2. All Search Results Page with Endless Scroll. Please note the image shows results with Prices, Product Categories and Product Tags.
...
4. The plugin auto adds a Predictive search Shortcode icon to all of your pages and posts visual editors. 
...
* Feature - Added Predictive Search Focus keywords set from Product edit page
* Feature - Added Exclude any product, post or page from serarch results
* Feature - Added Full integration with Yoast SEO and All In One SEO plugins
* Feature - Added Search by Product SKU
* Feature - Added search by Product Categories and Product Tags 
* Feature - Added embed search box by shortcode
* Feature - Added support for Predictive Search function PHP tag
* Feature - Added support for full integration with Google Analytics Site Search
...
= 2.1.6 =
Maintenance Update. Tweaked and tested for full compatibility with WordPress major version 4.5 and WP eCommerce version 3.11.2
